...
sintomade(mucosidad, bronquitis). %la mucosidades sintoma de bronquitis
sintomade(tos, bronquitis). %la tos es sintoma de bronquitis
...
diagnosticode([X|Xs] , E , K) :- buscar([X|Xs] , E , P) , cantSint(E , T) , K is P * 100 / T.
%---------------------------------------------------------------------------------------------------------------------
